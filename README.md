...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uzhgdja.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uzhgdja.containers.anotherwebservice.com/
...
```
git clone git@github.com:amstel85/container-uzhgdja.git
cd container-uzhgdja
```
...
```
docker attach container-uzhgdja
```
